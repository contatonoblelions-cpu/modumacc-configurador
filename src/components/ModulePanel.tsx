...
export function ModulePanel() {
  ...
  return (
    <aside className="order-2 w-full shrink-0 border-t border-brand-silver-200 bg-brand-bg p-2.5 md:order-none md:w-72 md:overflow-y-auto md:border-t-0 md:border-b-0 md:border-r md:p-4">
