...
export function ModulePanel() {
  ...
  return (
    <aside className="order-2 max-h-[20vh] w-full shrink-0 overflow-y-auto border-t border-brand-silver-200 bg-brand-bg p-2.5 md:order-none md:max-h-none md:w-72 md:border-t-0 md:border-b-0 md:border-r md:p-4">
