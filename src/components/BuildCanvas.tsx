...
export function BuildCanvas() {
  ...
  return (
    <div ref={outerRef} className="order-1 flex h-[60vh] shrink-0 overflow-y-auto overflow-x-hidden p-3 md:order-none md:h-auto md:flex-1 md:overflow-visible md:p-6">
      <div
        aria-hidden="true"
